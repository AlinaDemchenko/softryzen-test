  ...
  return (
    <section id="about" className="about">
      <div className="section-container">
        <div className="mr-[76px] md:h-[445px] xl:w-[606px] xl:h-fit xl:mr-6">
          <h2 className="title md:mb-[304px] xl:mb-[424px]">
            WHO <span className="font-medium">WE ARE</span>
          </h2>
          {isDesktop && <Description />}
          {!isDesktop && <Slogan />}
        </div>
        <div className="mt-[9px] md:mb-16 md:w-[220px] xl:w-[292px] xl:mt-4 xl:mr-3.5">
          <p className="mb-4 text-base/5 font-extralight xl:text-lg/6 xl:mb-6">
          ...
          <p className="text-base/5 font-extralight xl:text-lg/6">
